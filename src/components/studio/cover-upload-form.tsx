...
export function CoverUploadForm({ storybookId, currentAssetId }: CoverUploadFormProps) {
  ...
  async function upload(file: File) {
    ...
    try {
      ...
      formData.set("target", "storybook-cover");
  ...
  return (
    <div style={{ border: "1px dashed #cbd5e1", borderRadius: 8, padding: "0.75rem", background: "#f8fafc" }}>
      ...
      {uploadedAssetId ? <p style={{ marginTop: "0.5rem", color: "#065f46" }}>Cover uploaded and linked successfully.</p> : null}
